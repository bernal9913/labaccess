	...
	const drawerList = (
		...
		>
			<List>
				...
				<ListItem button component={Link} to="/dashboardDIPA">
					<ListItemText primary="Dashboard" />
				</ListItem>
				<ListItem button component={Link} to="/RegistroDIPA">
					<ListItemText primary="Registro de Entrada visitantes" />
				</ListItem>
				<ListItem button component={Link} to="/frequent-usersDIPA">
					<ListItemText primary="Usuarios Frecuentes" />
				</ListItem>
				<ListItem button component={Link} to="/SalidasDIPA">
