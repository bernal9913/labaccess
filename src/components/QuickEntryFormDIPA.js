...
const QuickEntryForm = () => {
	...
	const handleEntry = async () => {
		try {
			...
			await setDoc(doc(db, 'entriesD', entryID), {
				name,
				reason: entryReason,
				room,
				entryTime: entryTime,
		...
		<StyledFormContainer component={Paper}>
			...
			<FormControl fullWidth margin="normal">
				...
				<Select value={reason} onChange={(e) => setReason(e.target.value)}>
					<MenuItem value="Actividades Bioterio">Actividades Bioterio</MenuItem>
			...
			<FormControl fullWidth margin="normal">
				...
				<Select value={room} onChange={(e) => setRoom(e.target.value)}>
					...
					<MenuItem value="Sala de Cuarentena">Sala de cuarentena</MenuItem>
					<MenuItem value="Sala de Reproduccion 1">Sala de reproducción 1</MenuItem>
					<MenuItem value="Sala de Reproduccion 2">Sala de reproducción 2</MenuItem>
				</Select>
			</FormControl>
